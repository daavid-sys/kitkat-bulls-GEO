...
| **deploy-and-glue**         | `deploy-and-glue`   | `src/components/AuthGate.tsx`, `src/pages/{Setup,Settings}.tsx` — federico handles Lovable deploy outside any chat (no Vercel)                                                                       | components/Inbox/Sidebar/Header (without claim), services/, supabase/migrations/, supabase/functions/, vercel.json (not used) |
